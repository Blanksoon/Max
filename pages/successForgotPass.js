...
class SuccessForgotPass extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
              ...
              >
                {
                  this.state.translations.translation.common
                    .DESC1SUCCESSFORGOTPASSWORD
                }
              </h3>
              <h4 style={{ color: vars.black, fontWeight: 'normal' }}>
                {
                  this.state.translations.translation.common
                    .DESC2SUCCESSFORGOTPASSWORD
                }
              </h4>
              <h4
                style={{
...
SuccessForgotPass.getInitialProps = async ({ store, isServer, query, req }) => {
...
export default withRedux(initStore)(SuccessForgotPass)
