...
import ModalWechat from '../../containers/ModalWechat'
...
const ButtonAlipay = styled.button`
  ...
  height: 35px;padding: 8px 48px;`};
`
const ButtonCreditSub = styled.button`
  width: 318px;
  height: 60px;
  background-color: ${vars.white};
  color: ${vars.white};
...
const ButtonCredit = styled.button`
  ...
  height: 35px;`};
`
const ButtonpaypalSub = styled.button`
  width: 318px;
  height: 60px;
  background-color: ${vars.white};
  cursor: pointer;
...
class PurchaseItem extends React.Component {
  constructor(props) {
    ...
    this.purchaseWechat = this.purchaseWechat.bind(this)
  }
  ...
  async purchaseWechat() {
    ...
    if (this.props.id == 'live') {
      ...
      if (response) {
        ...
        this.props.closeModal()
        Router.push(
          `/QRcode?QR=${qr}&name=${this.props.product.programName}&price=${this
            .props.product.price}$`
        )
      }
    } else if (this.props.id == 'package') {
      ...
      renderUI = (
        <Wrapper>
          ...
          <WrapperDown>
            ...
            >
              <Box
                w={[12 / 12, 12 / 12, 6 / 12, 6 / 12, 6 / 12]} //w={[12 / 12, 6 / 12, 6 / 12, 6 / 12, 6 / 12]}
                pr={['0em', '0em', '0.5em', '0.5em', '0.5em']}
            ...
            <Flex
              pl={['3em', '0em', '3em', '3em', '3em']}
              pr={['3em', '0em', '3em', '3em', '3em']}
              pt={['1em', '0em', '1em', '1em', '1em']}
              pb={['1em', '0.5em', '2em', '2em', '2em']}
              wrap
            >
              <Box
